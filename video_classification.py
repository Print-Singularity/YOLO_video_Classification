...
video = cv2.VideoCapture("202312181319.mp4")
writer = None
...
# Replace with the correct paths to your configuration and weights files
network = cv2.dnn.readNetFromDarknet("cfg\yolov3_custom_train.cfg",
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter("reslt_phone_classification.mp4", fourcc, 30,
